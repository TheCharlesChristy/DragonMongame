...
var topedge = Math.floor(relativeposition.top)
var leftedge = Math.floor(relativeposition.left)
console.log(topedge,leftedge)
...
class Friend{
    ...
    doclick(){
        ...
        container.style.top = String(this.position.y) + "px"
